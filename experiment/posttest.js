...
(function() {
  ...
  /////////////// Write the MCQ below in the exactly same described format ///////////////
    ...
    const myQuestions = [
      ...
      {
       question: "What will be the output of the following code?\nfor i in ''.join(reversed(list('virtual'))):\n\tprint(i)",  ///// Write the question inside double quotes
        answers: {
          a: "v i r t u a l",                  ///// Write the option 1 inside double quotes
          b: "Error",
          c: "l a u t r i v",
      ...
      },
      {
        question: "What is the output of the following?\nfor i in [a, b, c, d][::-1]:\n\tprint (i)",  ///// Write the question inside double quotes
         answers: {
           a: "a b c d",                  ///// Write the option 1 inside double quotes
           b: "Error",                  ///// Write the option 2 inside double quotes
           c: "None",                  ///// Write the option 3 inside double quotes
